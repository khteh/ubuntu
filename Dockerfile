...
RUN apt upgrade -y
RUN apt install -y software-properties-common apt-transport-https python3 curl sudo gnupg mysql-client dnsutils wget git nodejs npm python3-pip pipenv unzip
